...
const defaultSlides: Slide[] = [
  {
    id: 1,
    title: "",
    titleAnimate: "Consult a GP Online",
    subtitle: "Care at Home, anytime you need",
    features: [
      "Speak to health professionals online",
      "Consult via phone or video calls",
      "Secure and confidential service",
      "No waiting room hassles",
      "GP on call",
    ],
    description: "*ONLINE GP CONSULTATION @ €45 Now €36",
    buttonText: "Book an appointment",
    buttonLink: "/online-gp-appointment",
  },
  {
    id: 2,
    title: "Online Treatment and ",
    titleAnimate: "Prescription Services.",
    subtitle: "Request Prescriptions from Home",
    features: [
      "Reviewed by trusted GPs online",
      "Prescriptions sent directly to your pharmacy",
      "Phone consultation when required",
      "Safe, reliable online care",
      "Medications approved after thorough evaluation",
    ],
    description: "",
    buttonText: "Book a prescription",
    buttonLink: "/treatments",
  },
  {
    id: 3,
    title: "Medical Certificates for ",
    titleAnimate: "Work, Travel & Employment.",
    subtitle: "Doctor on call for your Certificate needs",
    features: [
      "Reviewed by IMC-registered doctors",
      "Certificates issued within 4–24 hours",
      "Identity verified for every request",
      "Convenient online care from home",
      "Starting at €24.99",
    ],
    description: "",
    buttonText: "Get A certificate now",
    buttonLink: "/online-medical-certificates",
  },
];

...
import refundPolicyData from "./refund-policy-data.json";
...
export default function RefundPolicy() {
    ...
    return (
        <>
            ...
            <div className="flex items-center bg-[url(/images/Rectangle_1.jpg)] bg-top bg-center bg-no-repeat bg-cover min-h-[400px] md:min-h-[440px] relative">
                <div className='
                ...
                <div className="container">
                    <div className="flex flex-col text-white md:mt-16">
                        <h1 className="text-[40px] font-bold mb-2">Refund Policy</h1>
                ...
                <div className="container">
                    <div className="max-w-6xl mx-auto">
                        <div className="text-center pb-8 md:pb-16">
                            <h2 className="text-(--maincolor) text-3xl lg:text-5xl font-bold mb-5 md:mb-8">Refund Policy</h2>
                            <p className="!text-(--maincolor) !text-lg/7 font-normal">
                                Please carefully review our refund policy to understand your rights and the procedures involved.
                            </p>
                        ...
                        <div className="space-y-4">
                            {refundPolicyData.items.map((item, index) => (
                                <div
                                    key={index}

...
export default function TermsCondition() {
    ...
    return (
        <>
            ...
            {/* Banner */}
            <div className="flex items-center bg-[url(/images/terms_bg.png)] bg-top bg-center bg-no-repeat bg-cover min-h-[400px] md:min-h-[440px] relative">
                <div className='
                ...
                <div className="container">
                    <div className="flex flex-col text-white md:mt-16">
                        <h1 className="text-[40px] font-bold mb-2">Terms & Conditions</h1>
                ...
                <div className="container">
                    <div className="max-w-6xl mx-auto">
                        <div className="text-center pb-8 md:pb-16">
                            <h2 className="text-(--maincolor) text-3xl lg:text-5xl font-bold mb-5 md:mb-8">Introduction</h2>
                            <p className="!text-(--paracolor) !text-base/7 font-normal">
                                These terms and conditions (the “Terms”) govern your use of the NexGen Healthcare website (the “Website”) and the at-home blood testing kits and related services provided by NexGen Healthcare (the “Company”). By using the Website and ordering our testing kits, you agree to be bound by these Terms. If you do not agree to these Terms, you should not use the Website or Services.
                            </p>
                        ...
                        <div className="space-y-4 mb-14">
                            {termsConditionsData.items.map((item, index) => (
                                <div
                                    key={index}
